	...
	<div class="inwrap">
		...
		<ul class="tab_btn_group">
			<li class="item on" data-tab="tab-1" value="" onclick="selectBdMainInfoList();">
				<a href="javascript:;">All (<span class="totalCnt"></span>) </a>
			</li>
			<li class="item" data-tab="tab-2" value="12" onclick="selectBdMainInfoList(12);">
				<a href="javascript:;">Opening Soon (<span id="expectCnt"></span>)</a>
			</li>
			<li class="item" data-tab="tab-3"  value="13"  onclick="selectBdMainInfoList(13);">
				<a href="javascript:;">Open (<span id="bidingCnt"></span>)</a>
			</li>
			<li class="item" data-tab="tab-5" value="31"  onclick="selectBdMainInfoList(31);">
				<a href="javascript:;">Closed/Aborted (<span id="endCnt"></span>) </a>
			</li>
		</ul>
		<!-- TAB BUTTON :: END -->
