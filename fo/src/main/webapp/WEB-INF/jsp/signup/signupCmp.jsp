	...
	<div class="wrapper pt0">
	    ...
	    <div class="container">
	        ...
	        <div class="section us type2">
	            <div class="inwrap">              
	              <div class="signup-t-center"><img src="/guide/images/us/icon_signup_user_done.png" alt=""></div>
	              <div class="hgroup mt60">
	                <div>
	                  <h2 class="h2">구매입찰 시스템 가입완료</h2>
	                  <p class="signup-txt-info mt40">
	                    <span class="sign-user">서린닷컴 입찰회원 가입이 완료 되었습니다.<br>
	              ...
	              <div class="btn-wrap singup-btn-wrap">
	              	<button type="button" class="btn-blue-big full" onclick="pageMove('/');">메인으로 이동하기</button>
	              </div>       
	            </div>            
	        </div>
	        <!--// 본문 -->
