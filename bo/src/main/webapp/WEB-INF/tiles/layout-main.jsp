...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<c:url value='/js/vakata-jstree-4a77e59/dist/themes/default/style.min.css'/>"><!-- Folder tree -->
        <link rel="stylesheet" type="text/css" href="<c:url value='/js/bootstrap-timepicker-0.5.2/css/bootstrap-timepicker.css'/>">
        <link rel="stylesheet" type="text/css" href="<c:url value='/js/fullcalendar-5.7.0/lib/main.css'/>"><!-- Full calendar -->
	...
	<body>
        ...
        <script type="text/javascript" src="<c:url value='/js/jquery.i18n.properties.js'/>"></script>
        ...
        <!-- realGrid -->
        <script type="text/javascript" defer src="<c:url value='/js/realgrid.2.3.2/realgrid-lic.js'/>"></script>
        <script type="text/javascript" defer src="<c:url value='/js/realgrid.2.3.2/realgrid.2.3.2.min.js'/>"></script> 
        <script type="text/javascript" defer src="<c:url value='/js/realgrid.2.3.2/libs/jszip.min.js'/>"></script>
        <!-- //realGrid -->
        <script type="text/javascript" defer src="<c:url value='/js/bootstrap-4.6.0/js/dist/util.js'/>"></script>
        <script type="text/javascript" defer src="<c:url value='/js/bootstrap-4.6.0/js/dist/modal.js'/>"></script>
        <script type="text/javascript" defer src="<c:url value='/js/bootstrap4-datepicker-master/js/bootstrap-datepicker.js'/>"></script>
        <script type="text/javascript" defer src="<c:url value='/js/bootstrap4-datepicker-master/js/locales/bootstrap-datepicker.ko.js'/>"></script>
        <script type="text/javascript" defer src="<c:url value='/js/bootstrap-timepicker-0.5.2/js/bootstrap-timepicker.js'/>"></script>
        <script type="text/javascript" defer src="<c:url value='/js/vakata-jstree-4a77e59/dist/jstree.min.js'/>"></script><!-- Folder tree -->
        <script type="text/javascript" defer src="<c:url value='/js/fullcalendar-5.7.0/lib/main.js'/>"></script><!-- Full calendar -->
        <script type="text/javascript" defer src="<c:url value='/js/fullcalendar-5.7.0/lib/locales/ko.js'/>"></script><!-- Full calendar(한글) -->
        <script type="text/javascript" defer src="<c:url value='/js/common.js'/>"></script><!-- 퍼블 작성 -->
        
        
        <script type="text/javascript" defer src="<c:url value='/js/sorinMessage-bo.js'/>"></script>     
        <script type="text/javascript" defer src="<c:url value='/js/ckeditor/ckeditor.js'/>"></script>
        ...
        <script type="text/javascript" defer src="<c:url value='/js/jquery.validationEngine.js'/>"></script>
		<script type="text/javascript" defer src="<c:url value='/js/jquery.validationEngine-ko.js'/>"></script>
